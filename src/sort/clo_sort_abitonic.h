...
#define CLO_SORT_SBITONIC_KNAME_PRIV_2S4V "abit_priv_2s4v"
...
#define CLO_SORT_ABITONIC_KERNELNAMES {CLO_SORT_SBITONIC_KNAME_ANY, \
	...
	CLO_SORT_SBITONIC_KNAME_PRIV_2S4V, CLO_SORT_SBITONIC_KNAME_PRIV_3S8V, \
	CLO_SORT_SBITONIC_KNAME_PRIV_4S16V, CLO_SORT_SBITONIC_KNAME_HYB_S4_2S4V, \
	CLO_SORT_SBITONIC_KNAME_HYB_S6_2S4V, CLO_SORT_SBITONIC_KNAME_HYB_S8_2S4V, \
	CLO_SORT_SBITONIC_KNAME_HYB_S10_2S4V, CLO_SORT_SBITONIC_KNAME_HYB_S12_2S4V, \
	CLO_SORT_SBITONIC_KNAME_HYB_S3_3S8V, CLO_SORT_SBITONIC_KNAME_HYB_S6_3S8V, \
	CLO_SORT_SBITONIC_KNAME_HYB_S9_3S8V, CLO_SORT_SBITONIC_KNAME_HYB_S12_3S8V, \
	CLO_SORT_SBITONIC_KNAME_HYB_S4_4S16V, CLO_SORT_SBITONIC_KNAME_HYB_S8_4S16V, \
	CLO_SORT_SBITONIC_KNAME_HYB_S12_4S16V}
