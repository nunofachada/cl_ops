...
/** Name of single selection sort kernel. */
#define CLO_SORT_GSELECT_KNAME_0 "gselectSort"
#define CLO_SORT_GSELECT_KNAME_1 "gselectCopy"

/** Number of command queues used by the selection sort. */
#define CLO_SORT_GSELECT_NUMQUEUES 1

/** Number of kernels used by the selection sort. */
#define CLO_SORT_GSELECT_NUMKERNELS 2

/** Array of strings containing names of the kernels used by the selection sort strategy. */
#define CLO_SORT_GSELECT_KERNELNAMES {CLO_SORT_GSELECT_KNAME_0, CLO_SORT_GSELECT_KNAME_1}

/** Sort elements using the selection sort. */
